class Hero():
    ...
    def gainExp(self, input):
        self.__exp = input # setiap dapet exp masuk ke exp
        if(self.__exp >= 100):  #jika exp melebihi 100 
            self.levelUp = self.__exp//100 #akan naik level setiap melebihi 100
            self.__exp %= 100 #sisa dari 100 masuk ke exp lagi
